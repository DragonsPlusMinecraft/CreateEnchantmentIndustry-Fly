...
public class ForgerScene {
    ...
    public static void superEnchant(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().createEntity(level -> {
            ...
            Vec3 position = Vec3.atBottomCenterOf(util.grid().at(2, 2, 2));
    ...
    public static void automate(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(input, DepotBlockEntity.class,
                depot -> depot.setHeldItem(new TransportedItemStack(Items.DIAMOND_SWORD.getDefaultInstance())));
        ...
        scene.world().modifyBlockEntity(input2, DepotBlockEntity.class,
                depot -> depot.setHeldItem(new TransportedItemStack(template)));
        ...
        scene.world().modifyBlockEntity(
                input, DepotBlockEntity.class, depot -> depot.setHeldItem(new TransportedItemStack(ItemStack.EMPTY)));
        ...
        scene.idle(20);
        scene.world().modifyBlockEntity(
                input2, DepotBlockEntity.class, depot -> depot.setHeldItem(new TransportedItemStack(ItemStack.EMPTY)));
        ...
        scene.overlay().showText(60)
                ...
                .attachKeyFrame();
        scene.world().modifyBlockEntity(input, DepotBlockEntity.class,
                depot -> depot.setHeldItem(new TransportedItemStack(CEIItems.EXPERIENCE_CAKE.asStack())));
        scene.idle(10);
        scene.world().instructArm(armPos, ArmBlockEntity.Phase.MOVE_TO_INPUT, ItemStack.EMPTY, 0);
        scene.idle(20);
        scene.world().modifyBlockEntity(
